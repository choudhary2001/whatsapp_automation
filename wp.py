...
msgentry = Entry(root, font="Helvetica 16 bold italic ")
msgentry.place(x=400, y=70)

contactentry=Entry(root, font="Helvetica 16 bold italic ")
contactentry.place(x=400, y=190)

msgcount = Spinbox(root, from_=0, to=1000
                   , width=10, font="bold 16")
...
send = Button(root, text="SEND", bg="red", fg="black", width=10, command=web, relief=GROOVE)
